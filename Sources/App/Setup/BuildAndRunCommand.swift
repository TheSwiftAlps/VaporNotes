...
public final class BuildAndRunCommand: Command {
    ...
    public let help = ["This commands performs build, test and run operations in one shot"]
    ...
    public func run(arguments: [String]) throws {
        ...
        console.print("==> vapor test")
        try console.foregroundExecute(program: "vapor", arguments: ["test"])
